...
class SearchUser extends Component {
    ...
    handleInputChange(event) {
        ...
        axios.post(`/api/v1/searchUsers`, { q: query, field: field })
            .then(res => {
        ...
        return (
            <div>
                ...
                <div >
                    ...
                    {(filteredData.user_name) ? (<div><p>
                        | User Name: {filteredData.user_name}
                    | Organization Name: {filteredData.organization_name}
                    | Submitter ticket subject: {filteredData.submitter_ticket_subject}
                    | Assignee ticket subject: {filteredData.assignee_ticket_subject}
                    |</p></div>) : ''}
                </div>
                <Footer />
            </div>
